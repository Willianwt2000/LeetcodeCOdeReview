    ...
    <section className="py-16 bg-gradient-to-br from-gray-50 to-orange-50/30">
      <div className="container">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold mb-4 text-gray-900">{t("components.whoWeServe.title")}</h2>
          <p className="text-gray-600 text-lg max-w-2xl mx-auto">{t("components.whoWeServe.subtitle")}</p>
        </div>
