...
export const QualificationCriteria = () => {
  ...
  return (
    <section className="py-12 lg:py-24 bg-gradient-to-r from-green-50 via-white to-blue-50 border-y border-green-100">
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{t('components.qualificationCriteria.minTimeInBusinessDesc')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{t('components.qualificationCriteria.minRevenueDesc')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{t('components.qualificationCriteria.minDocumentsDesc')}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{t('components.qualificationCriteria.idealTimeInBusinessDesc')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{t('components.qualificationCriteria.idealRevenueDesc')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{t('components.qualificationCriteria.idealFicoDesc')}</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{t('components.qualificationCriteria.idealProfitableDesc')}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 p-6 bg-white rounded-xl border border-orange-200 shadow-sm">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              ...
              <div>
                <p className="text-2xl font-bold text-primary">{t('components.qualificationCriteria.avgDecisionValue')}</p>
                <p className="text-sm text-muted-foreground">{t('components.qualificationCriteria.avgDecision')}</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-primary">{t('components.qualificationCriteria.fundingRangeValue')}</p>
                <p className="text-sm text-muted-foreground">{t('components.qualificationCriteria.fundingRange')}</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-primary">{t('components.qualificationCriteria.ratesFromValue')}</p>
