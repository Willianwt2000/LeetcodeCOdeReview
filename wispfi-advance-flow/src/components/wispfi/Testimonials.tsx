...
const baseReviews = [
  { name: "Gerard Vinci", role: "CEO, ALL SERVE COMMUNICATIONS", location: "Telecom Industry", quoteKey: "components.testimonials.quote1" },
  { name: "Steve Guy", role: "Enermuscle Marketing", location: "Broadband Expansion", quoteKey: "components.testimonials.quote2" },
  { name: "Joshua Aaron", role: "Montana Internet", location: "Telecom/Broadband", quoteKey: "components.testimonials.quote3" },
...
interface TestimonialsProps { className?: string; limit?: number; showSeeAllLink?: boolean }
  ...
  return (
    <section className={cn("container py-16", className)}>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <h2 className="text-2xl sm:text-[32px] sm:leading-[40px] font-semibold">{t('components.testimonials.title')}</h2>
      ...
      {showSeeAllLink && (
        <div className="mt-6 text-center">
          <a href="/case-studies" className="underline">{t('components.testimonials.seeAllLink')}</a>
        </div>
      )}
    </section>
  );
