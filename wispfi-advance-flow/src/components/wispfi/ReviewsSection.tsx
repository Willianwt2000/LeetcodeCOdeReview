  ...
  return (
    <section className="container py-16">
      <div className="text-center mb-12">
        <h2 className="text-2xl sm:text-[32px] sm:leading-[40px] font-semibold mb-4">
          {t("components.reviewsSection.title")}
        </h2>
      ...
      <div className="grid gap-8 md:grid-cols-3 max-w-6xl mx-auto">
        {reviews.map((review, index) => (
          <div key={index} className="bg-card rounded-card border p-6 shadow-card relative">
            ...
            <blockquote className="text-foreground mb-4 leading-relaxed">"{review.text}"</blockquote>

            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full overflow-hidden">
                <img src={review.image} alt={review.author} className="w-full h-full object-cover" loading="lazy" />
              </div>
              <div>
