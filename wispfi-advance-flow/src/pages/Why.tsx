...
const Why = () => {
  ...
  <div className="min-h-screen bg-background text-foreground">
    <Helmet>
      ...
      <meta name="description" content="Discover why WispFi is the best choice for fast business financing, fiber optic business loans, and WISP funding with transparent terms and industry expertise." />
      <link rel="canonical" href={canonical("/why")} />
      <meta property="og:title" content="The WispFi Advantage | Fast Business Financing" />
      <meta property="og:description" content="Fast, transparent funding built for the connectivity industry. Get approvals in 24 hours." />
    </Helmet>
    <SiteHeader />
    <main>
      {/* Hero Section */}
        ...
        <div className="container relative z-10 py-16">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground" onClick={() => setOpen(true)}>
                  ...
                  <table className="w-full">
                    <thead>
                      <tr className="border-b">
                        ...
                        <th className="text-center p-6 font-semibold text-muted-foreground">{t('why.traditionalLenders')}</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-b">
