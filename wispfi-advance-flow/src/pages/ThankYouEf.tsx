...
const ThankYouEf = () => {
  ...
  useEffect(() => {
    // Scroll to the top so the thank-you message is visible immediately
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Helmet>
        ...
        <meta
          name="description"
          content="Your equipment financing application has been received. Our team will review and contact you within 24 hours."
        />
      ...
      <main className="container py-16 lg:py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-12">
            ...
            <h1 className="text-4xl lg:text-5xl font-bold mb-4">{t("thankYouEf.title")}</h1>
            <p className="text-xl text-muted-foreground mb-6">{t("thankYouEf.subtitle")}</p>
          ...
          <div className="grid gap-8 md:grid-cols-3 mb-12">
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">{t("thankYouEf.applicationReviewDesc")}</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">{t("thankYouEf.personalContactDesc")}</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground">{t("thankYouEf.fastDecisionDesc")}</p>
              </CardContent>
            </Card>
          </div>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="flex items-center justify-center gap-3">
                ...
                <div>
                  ...
                  <a href={`tel:${t("thankYouEf.phoneNumber")}`} className="text-primary hover:underline">
                    {t("thankYouEf.phoneNumber")}
                  </a>
                </div>
              </div>
              <div className="flex items-center justify-center gap-3">
                ...
                <div>
                  ...
                  <a href={`mailto:${t("thankYouEf.emailAddress")}`} className="text-primary hover:underline">
                    {t("thankYouEf.emailAddress")}
                  </a>
                </div>
              </div>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-muted">
            <p className="text-xs text-muted-foreground">{t("thankYouEf.disclaimer")}</p>
          </div>
        </div>
      </main>
