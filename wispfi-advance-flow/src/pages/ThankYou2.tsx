...
import { Check, Upload, Phone, Clock, CheckCircle, MessageCircle, DollarSign, Calendar, Users, Shield, HelpCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <Helmet>
        ...
        <meta name="description" content="Thank you for applying! A funding specialist will contact you within 1 business day. Upload documents now for faster business funding approval." />
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-12">
                <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">
                  {t('thankYou2.uploadTitle')}
                </h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  {t('thankYou2.uploadSubtitle')}
                </p>
              </div>
              ...
              <div className="grid gap-8 lg:grid-cols-3 mb-8">
                ...
                <Card className="bg-white shadow-md hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground mb-4">
                      {t('thankYou2.bankStatementsDesc')}
                    </p>
                ...
                <Card className="bg-white shadow-md hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground mb-4">
                      {t('thankYou2.driversLicenseDesc')}
                    </p>
                    <div className="space-y-2">
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        <div className="bg-primary rounded-full text-white text-xs w-6 h-6 flex items-center justify-center flex-shrink-0 mt-1">1</div>
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <div className="bg-primary rounded-full text-white text-xs w-6 h-6 flex items-center justify-center flex-shrink-0 mt-1">2</div>
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <div className="bg-primary rounded-full text-white text-xs w-6 h-6 flex items-center justify-center flex-shrink-0 mt-1">3</div>
                        <div>
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 mb-8">
                <Card className="bg-gray-50 shadow-sm">
                  <CardContent className="p-6 text-center">
                    ...
                    <a href="tel:+18188580184" className="text-primary font-semibold hover:underline">
                      (818) 858-0184
                    </a>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-gray-50 shadow-sm">
                  <CardContent className="p-6 text-center">
                    ...
                    <a href="mailto:sales@wispfi.com" className="text-primary font-semibold hover:underline">
                      sales@wispfi.com
                    </a>
                  </CardContent>
                </Card>
