  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Helmet>
        ...
        <meta name="description" content="Expert insights on small business funding, economics, and finance. Get the latest strategies for business growth and funding success." />
                ...
                <div className="lg:flex lg:min-h-[500px]">
                  ...
                  <div className="lg:w-2/5 p-8 lg:p-12 flex flex-col justify-center bg-gradient-to-br from-background to-muted/5">
                    <div className="flex flex-wrap items-center gap-3 mb-6">
                      <Badge variant="default" className="bg-primary hover:bg-primary/90 text-primary-foreground px-4 py-2 text-sm font-semibold rounded-full shadow-lg">
                    ...
                    <div className="mt-4 flex flex-wrap gap-x-4 gap-y-1 text-sm text-slate-500 justify-center lg:justify-start">
                      ...
                      <time dateTime={filteredPosts[0].publishDate}>
                        {t('blog.published')} {new Date(filteredPosts[0].publishDate).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
                      </time>
                    </div>
                  </div>
                </div>
                ...
                {filteredPosts.length > 1 ? (
                  [
                    ...
                    ...(filteredPosts.length % 3 === 2 ? [
                      <div key="cta-filler" className="flex flex-col p-6 bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20 rounded-2xl shadow-sm overflow-hidden">
          ...
          <div className="mx-auto max-w-[1200px] px-6 lg:px-8 py-16 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <TrackedButton 
                ...
                size="lg" 
                href="/#eligibility-form"
                className="h-12 px-8 inline-flex items-center justify-center max-w-full border-2 border-[hsl(var(--brand-blue))] text-[hsl(var(--brand-blue))] font-bold hover:bg-[hsl(var(--brand-blue))] hover:text-white focus:outline-none focus:ring-2 focus:ring-[hsl(var(--brand-blue))] focus:ring-offset-2"
                trackingData={{
                  action: 'funding_calculator_click',
                  category: 'conversion',
                  label: 'blog_bottom_cta',
